...
pandas_type = pd.read_excel('QC standard File.xlsx', sheet_name='Facility-Year')
ws = wb['Facility-Year']
        ...
        for raw_year in raw_facility_year_pointer.columns:
            ...
            if raw_checker == 'no value':
                if raw_year == 'custody_tot':
                    ...
                    entire_custody_total += f'{current_year_again} for {current_facility_again}\n\n'
                elif raw_year in important_variables:
                    if raw_year == 'custody_49under':
                        entire_custody_49under += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_50to64':
                        entire_custody_50to64 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_65over':
                        entire_custody_65over += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_18to24':
                        entire_custody_18to24 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_25to44':
                        entire_custody_25to44 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_45to49':
                        entire_custody_45to49 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_50plus':
                        entire_custody_50plus += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_age_unknown':
                        entire_custody_age_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_male':
                        entire_custody_male += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_female':
                        entire_custody_female += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_gender_unknown':
                        entire_custody_gender_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race1_white':
                        entire_custody_race1_white += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race1_black':
                        entire_custody_race1_black += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race1_latino':
                        entire_custody_race1_latino += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race1_other':
                        entire_custody_race1_other += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race1_unknown':
                        entire_custody_race1_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race2_white':
                        entire_custody_race2_white += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race2_black':
                        entire_custody_race2_black += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race2_other':
                        entire_custody_race2_other += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'custody_race2_unknown':
                        entire_custody_race2_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_49under':
                        entire_mortality_49under += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_50to64':
                        entire_mortality_50to64 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_65over':
                        entire_mortality_65over += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_18to24':
                        entire_mortality_18to24 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_25to44':
                        entire_mortality_25to44 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_45to49':
                        entire_mortality_45to49 += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_50plus':
                        entire_mortality_50plus += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_age_unknown':
                        entire_mortality_age_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_male':
                        entire_mortality_male += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_female':
                        entire_mortality_female += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_gender_unknown':
                        entire_mortality_gender_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race1_white':
                        entire_mortality_race1_white += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race1_black':
                        entire_mortality_race1_black += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race1_latino':
                        entire_mortality_race1_latino += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race1_other':
                        entire_mortality_race1_other += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race1_unknown':
                        entire_mortality_race1_unknown += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race2_white':
                        entire_mortality_race2_white += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race2_black':
                        entire_mortality_race2_black += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race2_other':
                        entire_mortality_race2_other += f'{current_year_again} for {current_facility_again}\n\n'

                    if raw_year == 'mortality_race2_unknown':
                        entire_mortality_race2_unknown += f'{current_year_again} for {current_facility_again}\n\n'
